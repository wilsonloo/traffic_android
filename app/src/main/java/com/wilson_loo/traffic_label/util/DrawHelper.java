...
public class DrawHelper {
    ...
    public void draw(FaceRectView faceRectView, ArrayList<Classifier.Recognition> drawInfoList) {
     ...
     * @param paint             画笔
     */
    public static void drawFaceRect(FaceRectView view, Canvas canvas, Classifier.Recognition drawInfo, int faceRectThickness, Paint paint) {
